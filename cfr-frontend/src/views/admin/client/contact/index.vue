  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="120px">
          <el-form-item label="Title" prop="title">
            <mavon-editor ref="md" v-model="form.title" required :style="'height:' + height" language="en" @imgAdd="imgAdd" />
            <!-- <el-input v-model="form.title" style="width: 370px;" /> -->
          </el-form-item>
          <el-form-item label="Description" prop="description">
            <mavon-editor ref="md" v-model="form.description" required :style="'height:' + height" language="en" @imgAdd="imgAdd" />
      ...
      >
        ...
        <el-table-column prop="bookingtime" label="BookingTime" />
